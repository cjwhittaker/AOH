Public Class tactical_1914
    ...
    Private Sub suppressed_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles suppressed.CheckedChanged
        ...
        If french.Checked And suppressed.Checked Then french.Checked = False
    End Sub
    Private Sub french_CheckedChanged(sender As Object, e As EventArgs) Handles french.CheckedChanged
    ...
    Private Sub nextphase_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles nextphase.Click
        If movement_1914.Visible Then movement_1914.Hide()
